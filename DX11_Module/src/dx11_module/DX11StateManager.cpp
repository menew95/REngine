...
namespace graphics
{
	namespace DX11
	{
		static constexpr bool IsCompatibleToD3DViewport()
		{
			...
			return
				(
					sizeof(D3D11_VIEWPORT) == sizeof(math::Viewport) &&
					offsetof(D3D11_VIEWPORT, TopLeftX) == offsetof(math::Viewport, x) &&
					offsetof(D3D11_VIEWPORT, TopLeftY) == offsetof(math::Viewport, y) &&
					offsetof(D3D11_VIEWPORT, Width) == offsetof(math::Viewport, width) &&
					offsetof(D3D11_VIEWPORT, Height) == offsetof(math::Viewport, height) &&
					offsetof(D3D11_VIEWPORT, MinDepth) == offsetof(math::Viewport, minDepth) &&
					offsetof(D3D11_VIEWPORT, MaxDepth) == offsetof(math::Viewport, maxDepth)
					);
		}
