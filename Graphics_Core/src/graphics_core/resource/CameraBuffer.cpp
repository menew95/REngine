...
namespace graphics
{
	...
	void CameraBuffer::UpdateCascadeShadow(math::Vector3 directionalLightDir)
	{
		...
		m_cascadedInfo._cascadeOffset.x = m_cameraInfo._near;
		m_cascadedInfo._cascadeOffset.y = m_cameraInfo._near;
		m_cascadedInfo._cascadeOffset.z = m_cameraInfo._near;
		m_cascadedInfo._cascadeOffset.w = m_cameraInfo._near;
	}
